function handleMouseOver(button) {
    ...
    button.style.animation = 'none'; // Сброс анимации перед добавлением
    button.offsetHeight; // Перезапускаем анимацию
    button.style.animation = 'scale(1.1) 0.6s ease'; // Увеличение кнопки
}
...
function handleMouseOut(button) {
    ...
    // Сбрасываем анимацию
    button.style.animation = 'none'; // Сброс анимации
}
